...
def generate_report(data):
    ...
    Provide a detailed analysis plan that includes anything that you think is relevant to the dataset. The analysis should include the following:
...
def answer_user_query(data, query):
